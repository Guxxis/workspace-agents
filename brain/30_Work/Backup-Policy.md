...
Para evitar *deadlocks* de disco em partições limitadas (conforme visto no [[32_Diagnostics/Diagnostic-DSW-SOLUCOES-DSW01-backup|RCA do SOLUCOES-DSW01]]), a ordem de execução nos scripts deve ser:
